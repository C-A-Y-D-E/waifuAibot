...
def send_anime(message):
    try:
        ...
        previous_msg = bot.reply_to(
            message, text='''<a href='tg://user?id={userid}'>{user}</a> - 👧Your Waifu is being generated… Please wait!'''.format(user=message.from_user.first_name, userid=message.from_user.id), parse_mode='HTML')
        print(text)
...
<a href='https://t.me/WifuARBToken'>Join Waifu</a> |  <a href='https://waifuarb.com'>Website</a> |  
